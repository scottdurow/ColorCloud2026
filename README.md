...
|---|-----|----------|-------------|
| 1 | [GitHub Copilot Quick Start](Labs/Lab%201%20-%20GitHub%20Copilot%20Quick%20Start/README.md) | 45 min | Set up VS Code and Copilot. Create custom agents, run the Wheels vs Doors debate, and learn sub-agent orchestration — all before writing any code. |
| 2 | [Connecting to the Platform](Labs/Lab%202%20-%20Connecting%20to%20Dataverse/README.md) | 45 min | Configure PAC CLI auth and MCP servers (Dataverse + Playwright). Import the Event Schedule Designer solution and generate sample data — using agents to do real setup work. |
| 3 | [Generative Pages](Labs/Lab%203%20-%20Generative%20Pages/README.md) | 60 min | Build a Schedule Builder page using GitHub Copilot and the Gen Pages skill. Deploy to a model-driven app via PAC CLI. Iterate on the layout and interaction design. |
| 4 | [Dataverse Plugins](Labs/Lab%204%20-%20Dataverse%20Plugins/README.md) | 60 min | Use the Developer agent to create a Dataverse plugin that enforces scheduling conflict rules server-side. Describe the business rule in plain English; the agent handles the C#, deployment, and testing. |
...
| Lab | Duration | Description |
|-----|----------|-------------|
| [Vibe Apps](Labs/Side%20Quest%20-%20Vibe%20Apps/README.md) | ~20 min | Build a similar app at vibe.powerapps.com and compare the managed experience with the full-control Copilot approach. |
| [Code Apps](Labs/Side%20Quest%20-%20Code%20Apps/README.md) | ~60 min | Plan and build a full React Code App using multi-agent workflows (Consultant + Developer agents), Fluent UI, and Dataverse integration. |
